import { innerClassContainerForum,innerClassContainerOrang,innerClassContainerTugas } from '../components/cInMengajar.js';
  ...
  return `
    ...
    <div class="container-section" id="slider">
        <section id="forum" class="section-menu">
            ${innerClassContainerForum()}
        </section>
        <section id="tugas" class="section-menu">
            ${innerClassContainerTugas()}
        </section>
        <section id="orang" class="section-menu">
            ${innerClassContainerOrang()}
        </section>
    </div>
  `;
}
